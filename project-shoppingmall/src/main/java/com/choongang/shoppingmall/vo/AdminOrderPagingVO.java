...
public class AdminOrderPagingVO<T> {
	// 페이징한 데이터 목록
	private List<T> list;
	...
	public AdminOrderPagingVO(int totalCount, int currentPage, int sizeOfPage, int sizeOfBlock) {
	...
	public AdminOrderPagingVO(int category_id, int totalCount, int currentPage, int sizeOfPage, int sizeOfBlock) {
		this.totalCount = totalCount;
		this.currentPage = currentPage;
		this.sizeOfPage = sizeOfPage;
		this.sizeOfBlock = sizeOfBlock;
	...
	public String toString() {
		return "PagingVO [list=" + list + ", totalCount=" + totalCount + ", currentPage=" + currentPage
				+ ", sizeOfPage=" + sizeOfPage + ", sizeOfBlock=" + sizeOfBlock
