...
public class AdminProductsPagingVO<T> {
	// 페이징한 데이터 목록
	private List<T> list;
	...
	public AdminProductsPagingVO(int totalCount, int currentPage, int sizeOfPage, int sizeOfBlock) {
	...
	public AdminProductsPagingVO(int category_id, int totalCount, int currentPage, int sizeOfPage, int sizeOfBlock) {
		this.totalCount = totalCount;
		this.currentPage = currentPage;
		this.sizeOfPage = sizeOfPage;
		this.sizeOfBlock = sizeOfBlock;
